...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * |-----------------------------------------------------------|
   * |CAPS/MO2| A|  S|  D|  F|  G|  H|  J|  K|  L|  ;|  '|Return |
   * |-----------------------------------------------------------|
   * |Shift   |  Z|  X|  C|  V|  B|  N|  M|  ,|  .|  /|Shift | ` |
   * |-----------------------------------------------------------|
   * |Ctrl|Gui |Alt |      Space            |MO1|Gui |Alt  |Ctrl |
   * `-----------------------------------------------------------'
   */
    LAYOUT(
        ...
        KC_LSFT, XXXXXXX, KC_Z   , KC_X   , KC_C   , KC_V   , KC_B   , KC_N   , KC_M   , KC_COMM, KC_DOT , KC_SLSH, KC_RSFT,          KC_GRV,
        KC_LCTL,          KC_LGUI, KC_LALT, KC_SPC ,          KC_SPC ,          KC_SPC , MO(1), KC_RGUI ,XXXXXXX, KC_RALT ,          KC_RCTL),
   ...
   */
    ...
    LAYOUT(
        ...
        _______, _______, _______, _______, _______, _______, _______, _______, _______,  KC_DEL,  KC_END, KC_PGDN, KC_UP  ,          _______,
...
bool process_record_user(uint16_t keycode, keyrecord_t *record) {
  switch (keycode) {
    case MO(1):
      ...
      case LT(MO(2), KC_CAPS):
        if (record->event.pressed) {
          rgblight_enable();
          rgblight_mode(2);
          rgblight_sethsv(50, 255, 100);
        } else {
          // Change back to blue
          rgblight_sethsv(132, 255, 100);
          rgblight_mode(1);
